...
// you need to add this class to implement endlessscroll feature in your imagesearch project
// Every adapter view (list view and grid view) supports onscrollListener events
// this class extends onscrolllistener that supports most of the use cases.
